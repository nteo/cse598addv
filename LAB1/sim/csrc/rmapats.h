...
typedef struct {
    ...
    U  I1082;
    U  I1083;
    HsimSignalMonitor  * I1084;
    HsimPostNbaClkMonitor  * I1085;
    RP  I1086;
    RmaTimeStamp64  I650;
    U  I1087;
    RmaTimeStamp64  I1088;
    U  I1089;
    UB  I1090 :1;
    UB  I1091 :1;
    UB  I1092 :1;
...
typedef struct {
    U  I653;
    U  I661;
    RmaThreadSchedCompiledLoads  * I1134;
...
typedef struct {
    ...
    U  I1136;
    RmaIbfIp  * I1137;
    RmaThreadSchedCompiledLoadsArr  I1138;
} RmaJaguarIbnSchedCg;
typedef struct {
    RP  I1139;
} RmaRootCbkCg;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I990;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I990;
    ...
    RmaSeqPrimOutputOnClkOpt  I1243;
    RmaSeqPrimOutputEblkData  I1248;
...
void  rmaPropagate0_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1489, U  did);
...
void  rmaPropagate1_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1489, U  did);
